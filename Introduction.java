...
public class Introduction implements ActionListener{
    ...
    Introduction(){
        ...
        s[0] = "Arithmetic Quiz Game";
        s[1] = "Project name:    Arithmetic Quiz Game";
        s[2] = "Developed By:   Tayyab Ghouri";
        s[3] = "Department:      Software";
        s[4] = "Roll Number:     21SW158";
        s[5] = "Section:            1";
        ...
        homeButton = new JButton("Home",new ImageIcon("Home.jpg"));
        homeButton.setBounds(300, 400, 150, 60);
        homeButton.setFont(new Font("Ariel",Font.BOLD,25));
